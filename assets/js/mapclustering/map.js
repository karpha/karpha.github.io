...
function education_init_map_script(_map_id){
	...
	jQuery(document).on("click", ".cz-btnmapview", function() {
		jQuery('.cz-mapinnerbanner').toggleClass('cz-open');
	...
	if( _data_list.status == 'found' ){
		...
		for (var i=0; i < response_data.length; i++) {
			...
			boxText.className = 'cz-infoBox';
			
			var infobox_html = "";
			infobox_html += '<div class="cz-serviceprovider">';
			infobox_html += '<figure class="cz-featuredimg"><img src="'+response_data[i].image+'" alt="'+response_data[i].title+'"></figure>';
			infobox_html += '<div class="cz-companycontent">';
				if(response_data[i].featured == 'yes'){
					infobox_html += '<span class="cz-featured"><i class="fa fa-bolt"></i></span>';
				}
				/*if(response_data[i].featured == 'yes'){
					infobox_html += '<span class="cz-featured"><i class="fa fa-bolt"></i></span>';
				}*/
				//infobox_html += '<div class="cz-subjects">'+response_data[i].subjects+'</div>';
				infobox_html += '<ul class="cz-tags"><li><a class="cz-tag cz-featuredtag" href="#">featured</a></li><li><a class="cz-tag cz-verifiedtag" href="#">verified</a></li></ul>';
				infobox_html += '<div class="cz-title"><h3><a href="'+response_data[i].url+'">'+response_data[i].title+'</a></h3></div>';
				infobox_html += '<ul class="cz-matadata"><li><span class="cz-stars"><span></span></span></li><li><i class="fa fa-thumbs-o-up"></i><em>99% (1009 votes)</em></li></ul>';
			infobox_html += '</div>';
